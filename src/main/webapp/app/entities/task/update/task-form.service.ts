...
type TaskFormGroupContent = {
  ...
  experience: FormControl<ITask['experience']>;
  dificulties: FormControl<ITask['dificulties']>;
  learningPath: FormControl<ITask['learningPath']>;
...
export class TaskFormService {
  createTaskFormGroup(task: TaskFormGroupInput = { id: null }): TaskFormGroup {
    ...
    return new FormGroup<TaskFormGroupContent>({
      ...
      experience: new FormControl(taskRawValue.experience),
      dificulties: new FormControl(taskRawValue.dificulties),
      learningPath: new FormControl(taskRawValue.learningPath),
