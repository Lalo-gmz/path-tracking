...
describe('LearningPath Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'learning-path', component: LearningPathComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LearningPathComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.learningPaths?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to learningPathService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLearningPathIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLearningPathIdentifier).toHaveBeenCalledWith(entity);
