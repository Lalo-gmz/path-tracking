package com.padancodelab.l2e.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.padancodelab.l2e.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.padancodelab.l2e.repository.UserRepository.USERS_BY_EMAIL_CACHE);
