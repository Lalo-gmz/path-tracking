...
import com.padancodelab.l2e.service.StatusService;
...
/**
 * REST controller for managing {@link com.padancodelab.l2e.domain.Status}.
 */
@RestController
@RequestMapping("/api")
public class StatusResource {
     ...
     */
    @GetMapping("/statuses")
    public ResponseEntity<List<Status>> getAllStatuses(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
