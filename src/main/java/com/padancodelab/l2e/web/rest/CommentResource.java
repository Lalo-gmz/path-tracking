...
import com.padancodelab.l2e.repository.CommentRepository;
import com.padancodelab.l2e.service.CommentService;
...
/**
 * REST controller for managing {@link com.padancodelab.l2e.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
