...
import com.padancodelab.l2e.service.TaskService;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).experience(DEFAULT_EXPERIENCE);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).experience(UPDATED_EXPERIENCE);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getExperience()).isEqualTo(DEFAULT_EXPERIENCE);
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).experience(UPDATED_EXPERIENCE);
        ...
        assertThat(testTask.getExperience()).isEqualTo(UPDATED_EXPERIENCE);
    }
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).experience(UPDATED_EXPERIENCE);
