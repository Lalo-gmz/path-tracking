...
import com.padancodelab.l2e.repository.StatusRepository;
...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().name(DEFAULT_NAME).order(DEFAULT_ORDER);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().name(UPDATED_NAME).order(UPDATED_ORDER);
        return status;
    }
    ...
    void createStatus() throws Exception {
        ...
        assertThat(testStatus.getOrder()).isEqualTo(DEFAULT_ORDER);
    }
    ...
    void putExistingStatus() throws Exception {
        ...
        updatedStatus.name(UPDATED_NAME).order(UPDATED_ORDER);
        ...
        assertThat(testStatus.getOrder()).isEqualTo(UPDATED_ORDER);
    }
    ...
    void fullUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.name(UPDATED_NAME).order(UPDATED_ORDER);
